...
@ActiveProfiles("test")
class BookingDetailAuthorizationTest {
    ...
    void bookingDetailRequiresAuthentication() throws Exception {
        mockMvc.perform(get("/api/bookings/{publicId}", BOOKING_PUBLIC_ID))
    ...
    @Test
    void unrelatedPermissionCannotReadBookingDetail() throws Exception {
    ...
    @Test
    void bookingPermissionCanReadOwnedBookingDetail() throws Exception {
        var authentication = UsernamePasswordAuthenticationToken.authenticated(
                principal(42L),
                null,
        ...
        verify(bookingService).getMyBookingDetail(BOOKING_PUBLIC_ID, 42L);
    }
