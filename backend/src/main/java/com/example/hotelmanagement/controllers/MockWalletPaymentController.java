...
public class MockWalletPaymentController {

    private final MockWalletPaymentService mockWalletPaymentService;

    public MockWalletPaymentController(MockWalletPaymentService mockWalletPaymentService) {
    ...
    public PaymentStatusResponse submitResult(
        ...
        return mockWalletPaymentService.submitResult(
                bookingPublicId,
                paymentCode,
                request,
                principal.getId()
