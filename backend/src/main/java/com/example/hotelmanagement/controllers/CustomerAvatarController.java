...
@RestController
@RequestMapping(value = "/api/customer-profiles/me/avatar", produces = MediaType.APPLICATION_JSON_VALUE)
@PreAuthorize("hasRole('CUSTOMER')")
public class CustomerAvatarController {

    private final UserAvatarService userAvatarService;

    public CustomerAvatarController(UserAvatarService userAvatarService) {
    ...
    public ResponseEntity<AvatarUploadUrlResponse> createUploadUrl(
        ...
        return ResponseEntity.ok(userAvatarService.createCustomerUploadUrl(principal.getId(), request));
    }
    ...
    public ResponseEntity<AvatarResponse> confirmUpload(
        ...
        return ResponseEntity.ok(userAvatarService.confirmCustomerUpload(principal.getId(), request));
    }
}
